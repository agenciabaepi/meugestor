...
export function ContasAPagarClient({ contasAPagar: initialContasAPagar, totalPendente: initialTotal }: ContasAPagarClientProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Contas a Pagar</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm sm:shadow p-4 sm:p-6 border-l-4 border-red-500 dark:border-red-600">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">Vencidas</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm sm:shadow p-4 sm:p-6 border-l-4 border-blue-500 dark:border-blue-600">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">Próximas</p>
      ...
      {/* Contas Vencidas */}
      {vencidas.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm sm:shadow overflow-hidden border-l-4 border-red-500 dark:border-red-600">
          <div className="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-red-50 dark:bg-red-900/20">
          ...
          <div className="divide-y divide-gray-200 dark:divide-gray-700">
            {vencidas.map((conta) => (
              <div key={conta.id} className="p-4 sm:p-6 hover:bg-red-50/50 dark:hover:bg-red-900/10 transition-colors">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300">
                        Vencida
                      </span>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <div>
                        ...
                        <span className="text-red-600 dark:text-red-400 font-semibold">{formatDate(conta.date)}</span>
                      </div>
                    </div>
                  </div>
      ...
      {/* Próximas Contas */}
      {proximas.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm sm:shadow overflow-hidden border-l-4 border-blue-500 dark:border-blue-600">
          ...
          <div className="divide-y divide-gray-200 dark:divide-gray-700">
            {proximas.map((conta) => (
              <div key={conta.id} className="p-4 sm:p-6 hover:bg-blue-50/50 dark:hover:bg-blue-900/10 transition-colors">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <div>
                        <span className="font-medium">Vencimento:</span>{' '}
                        <span className="text-blue-600 dark:text-blue-400 font-semibold">{formatDate(conta.date)}</span>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 shrink-0">
      ...
      {contasAPagar.length === 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm sm:shadow p-8 sm:p-12 text-center">
          <CheckCircle2 className="w-16 h-16 text-emerald-400 dark:text-emerald-500 mx-auto mb-4" />
